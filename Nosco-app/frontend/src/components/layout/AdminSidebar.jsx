...
import { 
  FaHome, FaUsers, FaProjectDiagram, FaClock, FaReceipt,
  FaMoneyBillWave, FaChartLine, FaBell, FaEnvelope, 
  FaCog, FaSignOutAlt, FaChevronLeft, FaChevronRight
} from 'react-icons/fa';
...
const AdminSidebar = () => {
  ...
  const navItems = [
    ...
    { title: 'Project Invitations', icon: FaEnvelope, path: '/admin/project-invitations' },
          ...
          <div className="flex items-center space-x-3">
            ...
            {isExpanded && (
              <div>
                ...
                <p className="text-sm text-gray-400">{user?.position || 'Administrator'}</p>
              </div>
            )}
          </div>
        </div>
        ...
        <div className="p-4 border-t border-gray-700">
          <Link
            ...
            className={`flex items-center py-2 px-0 mb-2 rounded transition-colors duration-200
              ...
              no-underline`}
          >
            <FaCog className={`text-lg ${isExpanded ? 'mr-3' : 'mx-auto'}`} />
